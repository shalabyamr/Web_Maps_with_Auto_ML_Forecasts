...
## §1.Setup: Config.ini
The only file that requires user input is _**Config.ini**_ in _**Pipeline**_ folder.  Update the database login credentials and the [parent_dir](https://github.com/amr-y-shalaby/GGR473_Project/Pipeline/Config.ini) **_parent_dir_** without quotations as below.
